...
const studentGuide = [
  ...
  { emoji:"💳", title:"Your .edu Email = Free Money", tag:"Free Perks", color:T.coral, steps:["Amazon Prime Student: 6 months FREE, then ~.49/mo — free 2-day shipping, Prime Video, Prime Gaming.","Microsoft Office 365: 100% free — Word, Excel, PowerPoint, Teams + 1TB OneDrive storage.","Google AI Suite: Free for 1 year — Gemini 2.5 Pro, NotebookLM, 2TB storage. Sign up before Oct 6.","Notion Plus: Free for students — organize notes, tasks, and schedules in one place.","Spotify + Hulu bundle: ~.99/mo (normally 0+). Verified through UNiDAYS.","GitHub Student Developer Pack: Free domain, Canva Pro, GitHub Copilot AI, 00 in cloud credits + 100 more tools. Needs student ID to verify.","Adobe Creative Cloud: 60%+ off (~0/mo) — Photoshop, Premiere Pro, Illustrator, and 20+ apps.","Autodesk: 50+ software downloads free for 1 year. Great for engineering or design majors.","Apple Education Store: Up to 10% off Macs/iPads. Back-to-school promo (through Sept) may include free AirPods.","Handshake: Free verified internship and job listings — sign up with your .edu email.","UNiDAYS and Student Beans: Unlock hundreds of brand discounts — Nike, ASOS, Samsung, and more."], example:"Most students never claim these. Amazon Prime + Microsoft Office + Spotify alone saves $300+ per year." },
];
